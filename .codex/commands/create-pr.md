# Codex Prompt Template: create-pr
...
Paste or reference this template in Codex when you want the `create-pr` workflow. Preserve repository instructions from `AGENTS.md` and verify any GitHub or git side effects before running commands.
