# Codex Guidance: distributed

> Codex compatibility note: This guidance was migrated from `.claude/rules/distributed.md`. Treat it as project guidance for matching files; this migration does not claim automatic path-scoped rule enforcement.
