# Codex Guidance: config-yaml

> Codex compatibility note: This guidance was migrated from `.claude/rules/config-yaml.md`. Treat it as project guidance for matching files; this migration does not claim automatic path-scoped rule enforcement.
