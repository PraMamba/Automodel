# Codex Guidance: code-style

> Codex compatibility note: This guidance was migrated from `.claude/rules/code-style.md`. Treat it as project guidance for matching files; this migration does not claim automatic path-scoped rule enforcement.
# Code Style Rules
