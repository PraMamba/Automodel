...
2. Files changed and categorize by change type (see `.claude/data/review-pr-change-types.md`)
...
1. **Map changes to review templates** (see `.claude/data/review-pr-templates.md`)
...
Refer to `.claude/data/review-pr-change-types.md` for:
...
Refer to `.claude/data/review-pr-templates.md` for:
